...
if selected == "Signal Processing":
    ...
    if selected1 == 'Information':
        ...
        st.markdown(new_title, unsafe_allow_html=True)
        new_title = '<p style="font-family:Georgia; color:blue; font-size: 20px; text-align: Justify;">4. Moving Average FilterLangkah terakhir adalah penerapan filter rata-rata bergerak. Filter ini menghaluskan sinyal dan membantu mengurangi noise yang tersisa setelah langkah-langkah sebelumnya. Filter rata-rata bergerak juga membantu dalam menyoroti tren utama dalam sinyal.</p>'
        st.markdown(new_title, unsafe_allow_html=True)
